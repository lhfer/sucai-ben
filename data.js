window.INTEL_DATA = {
 ...
 "items": [
  ...
  },
  {
   ...
   "added": "2026-09-01",
   "category": "跨行业",
   "title": "三百万军职人员的门户，同一天放进了 ChatGPT 和 Grok",
   "prompt": "",
   "body": "五角大楼的 AI 门户 GenAI.mil 上线九个月，已经有一百七十万人登过。八月三十一日，军用版 ChatGPT 和政府版 Grok 同一天进去，跟原来的 Gemini 并排。这是给受控非密信息用的，云安全档叫影响等级五：敏感，但还没到保密。三百万军职人员，干的是计划、政策、后勤、行政，不是打仗。海军已经强制要求迁过去。\n\n陆军第十八空降军用它写一份南方司令部演习命令：九个写手，六周交卷。以前同等活要六到九个月、更多人。OpenAI 的人举的例子更土：填差旅单、对补给、写运输需求。数据不出政府环境，不拿去训公开模型。打仗用的模型走另一条还没公开的网。部门自己也说，门户上这些模型不打算用于作战。\n\n所以呢：军队先把聊天框用在填表和写命令上。真要上战场的那套，另走一条线。\n",
   "links": [
    {
