window.INTEL_DATA = {
  ...
  "items": [
    ...
    },
    {
      ...
      "prompt": "",
      "body": "周四夜里，德州州长格雷格·阿卖特下令：所有州机构先停掉给 Flock 车牌摄像头的钱。《得克萨斯论坛报》正要发调查——一个州机构靠给地方警局拨款，砸了至少三千万美元铺这张网。\n\n机动车犯罪预防局的董事会，大多是州长自己点的人。二零二三年以来，他们帮着装了至少三千两百台；大约一千两百台走州公安那份一千五百九十万、三年的合同。钱来自二零二三年那条法律：德州车险每张加一块，名义是打催化转换器盗窃。立法时有人说，Flock 根本没被拿出来讨论。这套系统不只认车牌，还认车型、颜色、贴纸、凹痕，机构能全国共享。阿卖特上电台说，这是因为城市在撕约。卢夫金一个警察面临大约一百项指控，拿它盯了十一人一年多。过去一个月，德州至少六个部门让警察停职或被起诉。\n\n所以呢：州钱一停，才看见这张网不是市里自己买的玩具。",
      "links": [
        {
          "label": "Texas Tribune",
